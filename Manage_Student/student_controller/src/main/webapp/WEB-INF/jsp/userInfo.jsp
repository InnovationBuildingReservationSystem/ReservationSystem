                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                <input type="text" id="form-field-1" name="snum" placeholder="学号"
                                       class="col-xs-10 col-sm-5" value="${snum}" required/>
                                <span class="help-inline col-xs-12 col-sm-7">
												<span class="middle" style="color: red;">${snumError}</span>
                                    </span>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                <input type="password" id="form-field-4" name="newPwd" placeholder="新密码"
                                       class="col-xs-10 col-sm-5" value="${newPwd}" required/>
                                <span class="help-inline col-xs-12 col-sm-7">
												<span class="middle" style="color: red;">${newPwdError}</span>
                                    </span>
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                <input type="password" id="form-field-5" name="newPwdConvinced" placeholder="再次输入密码"
                                       value="${newPwdConvinced}" required onkeypress="validPwdConvinced()"
...
<script type="text/javascript">
    function validPwdConvinced() {
        ...
        var obj1 = document.getElementsByName("form-field-5");
        ...
        if (pwd != pwd1) {
            ...
            obj1.style.border = "1px red solid";
            return false;
        } else {
            document.getElementById("pwdConvince").innerHTML = "<font size='-1' color='red'></font>";
            obj1.style.border = "1px solid gray";
            return true;
        }
    }
</script>
