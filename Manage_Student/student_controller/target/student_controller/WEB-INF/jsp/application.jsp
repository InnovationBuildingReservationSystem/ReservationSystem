                    ...
                    <div class="col-xs-12">
                        ...
                        <form action="${pageContext.request.contextPath}/student/applicationClassroom.html"
                            ...
                            <div class="row">
                                ...
                                <div class="form-group">
                                    <label class="col-sm-3 control-label no-padding-right" for="form-field-5"
                                           style="margin-left: -76px;">参加人数</label>
                                ...
                                <div class="form-group">
                                    <label class="col-sm-3 control-label no-padding-right" for="form-field-5"
                                           style="margin-left: -76px;">负责人</label>
                                ...
                                <div class="form-group">
                                    <label class="col-sm-3 control-label no-padding-right" for="form-field-5"
                                           style="margin-left: -76px;">学号</label>
                                ...
                                <div class="form-group">
                                    <label class="col-sm-3 control-label no-padding-right" for="form-field-5"
                                           style="margin-left: -76px;">活动团体名称</label>
                                ...
                                <div class="col-xs-12"><!--右-->
                                    <!--<div class="col-xs-3">
                                        <button type="submit" class="btn disabled btn-primary" style="height: 32px;padding-top: 1px;margin-left: 266px;width: 82px;">提交</button>
                                    </div>-->
                                    <div class="clearfix form-actions">
                                        <div class="col-md-offset-3 col-md-9" style="margin-left: 17%;">
