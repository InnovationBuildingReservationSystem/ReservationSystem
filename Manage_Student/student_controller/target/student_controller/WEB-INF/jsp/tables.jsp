        ...
        <div id="sidebar" class="sidebar                  responsive                    ace-save-state">
            ...
            <ul class="nav nav-list">
                ...
                <li class="active open">
                    <a href="tables.tables.jsp" class="dropdown-toggle">
                        <i class="menu-icon fa fa-list"></i>
                        <span class="menu-text"> 个人预订 </span>
                ...
                <li class="">
                    <a href="#" class="dropdown-toggle">
                        ...
                        <span class="menu-text"> 教室申请 </span>
                    ...
                    <ul class="submenu">
                        <li class="">
                            <a href="${pageContext.request.contextPath}/form-elements.html">
                                <i class="menu-icon fa fa-caret-right"></i> 教室申请
                            </a>
                   	...
                   	<div class="form-group">
						<label class="col-sm-2 control-label no-padding-right" for="form-field-1"> 教室 </label>
                			...
                			<div class="col-sm-2">
								...
								<input class="form-control date-picker" id="datepicker" type="text" data-date-format="yyyy-mm-dd" value=""/>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <div class="hidden-sm hidden-xs action-buttons">
                                                    <button class="btn btn-minier btn-white btn-warning btn-bold">
