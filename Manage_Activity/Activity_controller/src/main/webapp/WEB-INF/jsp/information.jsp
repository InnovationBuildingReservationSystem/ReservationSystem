...
<body class="no-skin" style="background: no-repeat">
    <div class="main-content">
        <div class="center">
            <img src="${pageContext.request.contextPath}/assets/images/QRcode/QRcode.jpg" class="img-responsive center-block" >
        </div>
</div>
